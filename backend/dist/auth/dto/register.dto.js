...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'usuario@email.com', description: 'Correo electrónico' }),
    (0, class_validator_1.IsEmail)({}, { message: 'El correo electrónico no es válido.' }),
    __metadata("design:type", String)
], RegisterDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'MiPassword123!', description: 'Contraseña (mínimo 6 caracteres)' }),
